                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel-body">
                                    <form class="form-horizontal form-validate-jquery" id="product" action="{{ route('admin.banner.create') }}"
                                        ...
                                        <fieldset class="content-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="url" name="url" value="{{ old('url') }}" class="form-control"  placeholder="Enter Banner URL" autocomplete="off" required="">
                                                    @if($errors->get('url'))
