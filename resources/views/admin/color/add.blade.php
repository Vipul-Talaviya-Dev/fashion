            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h1 class="panel-title">Color Add</h1>
                    </div>
                    <hr/>
                    <div class="container-fluid">
                        <div class="row">
                            <table class="panel-body">
                                <form class="form-horizontal form-validate-jquery" id="product" action="{{ route('admin.color.create') }}"
                                      method="post">
                                    {{ csrf_field() }}
                                    <fieldset class="content-group">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" name="code" id="color" class="form-control colorpicker-flat-full" data-preferred-format="hex" value="#45818e">
                                            </div>
                                    ...
                                    <fieldset class="content-group">
                                        <div class="form-group">
                                            <div class="col-lg-3">
                                                <input type="hidden" name="color" id="cname" value="">
                                            </div>
                                            <div class="col-lg-2">
