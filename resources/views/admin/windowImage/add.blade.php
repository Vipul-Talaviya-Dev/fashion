                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel-body">
                                    <form class="form-horizontal form-validate-jquery" id="product" action="{{ route('admin.windowImage.create') }}"
                                        ...
                                        <fieldset class="content-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="url" name="url" value="{{ old('url') }}" class="form-control"  placeholder="Enter URL" autocomplete="off" required="">
                                                    @if($errors->get('url'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-lg-2 control-label text-semibold">Image file
                                                    upload:</label>
                                                <div class="col-lg-8">
                                                    <input type="file" name="image" class="file-styled" accept=".jpeg, .jpg, .png, .gif" required>
                                                    @if($errors->get('image'))
