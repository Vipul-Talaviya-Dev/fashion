                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel-body">
                                    <form class="form-horizontal form-validate-jquery" id="product" action="{{ route('admin.windowImage.update',['id'=> $windowImage->id]) }}"
                                        ...
                                        <fieldset class="content-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="url" name="url" value="{{ $windowImage->link ?: old('url') }}" class="form-control"  placeholder="Enter Banner URL" autocomplete="off" required="">
                                                    @if($errors->get('url'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <label class="radio-inline">
                                                        <input type="radio" checked name="status" @if($windowImage->status==2) {{'checked'}} @endif  value="1">
                                                        Active
                                                    </label>

                                                    <label class="radio-inline">
                                                        <input type="radio" name="status"  @if($windowImage->status==2) {{'checked'}} @endif  value="2">
                                                        In-Active
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <textarea name="description" class="form-control" rows="5">{{ $windowImage->description }}</textarea>
                                                </div>
                                                <div class="col-lg-1"></div>
                                            </div>
                                            <div class="form-group">
