                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel-body">
                                    <form class="form-horizontal form-validate-jquery" id="product" action="{{ route('admin.brand.create') }}"
                                        ...
                                        <fieldset class="content-group">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" name="name" value="{{ old('name') }}" class="form-control"  placeholder="Enter Brand Name" autocomplete="off" required="">
                                                    @if($errors->get('name'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <span class="help-block">Minimum image size required (500 * 800)</span>
                                                    @if($errors->get('image'))
